...
{	
	...
	puts("UH OH! You have triggered a bomb! The bomb can only be disabled between 15-20 seconds. The bomb will alert you when the time has started. Press any key when you want to disable the bomb. Be careful! Press to early or wait to long, you go BOOM!\n");
